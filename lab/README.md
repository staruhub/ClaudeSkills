# Lab — experimental & personal skills | 实验区

Skills here are **not part of the curated set** on the repo homepage. They work, but they are personal-use or niche tools that haven't earned (or don't aim for) the full quality bar of `skills/` — some may graduate into `skills/`, some may move to a separate repo, some may be retired.

这里的 skill **不属于首页的精选集**。它们能用，但属于个人向或小众工具，尚未达到（或不追求）`skills/` 的完整质量标准——未来可能毕业进入 `skills/`，可能拆到独立仓库，也可能退役。
...
| [`weather-forecast-report`](Geek-skills-weather-forecast-report/SKILL.md) | Weather element research report generator | 天气要素研究报告生成器 |
...
Capability & risk notes for these skills remain in [SECURITY.md](../SECURITY.md), marked *(lab)*.
这些 skill 的能力与风险说明仍在 [SECURITY.md](../SECURITY.md) 中，以 *(lab)* 标记。
